    ...
    <div className="my-20 pt-10" id="about">
      ...
      <div>
        <p className="my-5">
          ...
          survive on the internet. My interest became more strong when I decided
          to create a custom blogging site where everyone can post there
          writings and share those things on different platfroms.
        </p>
        <p className="my-5">
        ...
        <div className="flex gap-10">
          ...
          <ul className="text-sm">
            ...
            <li className="my-2">
              <BsArrowRightShort className="inline-block text-red-400" /> Framer
              Motion
            </li>
            <li className="my-2">
              <BsArrowRightShort className="inline-block text-red-400" />{" "}
      ...
      <div className="mt-16">
        <h1 className="text-4xl font-bold">
          <span className="text-red-400">#</span> My Experience
        </h1>
